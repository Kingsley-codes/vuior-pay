  ...
  return (
    <header className="site-header">
      ...
      <div className="nav-actions">
        ...
        <Link href="/#signup" className="button button-primary button-small"><span className="signup-long">Create free account</span><span className="signup-short">Sign up</span></Link>
      </div>
    </header>
  );
}
